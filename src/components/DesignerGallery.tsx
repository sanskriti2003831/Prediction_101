  ...
  schiaparelli: [
    {
      ...
      year: '2025',
      images: [
        { id: '1', imageUrl: '/images/AllRunwayImages/SchiaparelliLook1.png', look: 1, colorPalette: ['#c4b49e', '#efdbd2', '#e9e5d5', '#a4a38d', '#c4c0a7'] },
        { id: '2', imageUrl: '/images/AllRunwayImages/SchiaparelliLook2.png', look: 2, colorPalette: ['#f5e3c7', '#e2d9c2', '#d0c6a5', '#c6b4a1', '#d8c1a5'] },
        { id: '3', imageUrl: '/images/AllRunwayImages/SchiaparelliLook3.png', look: 3, colorPalette: ['#f8e0b7', '#d6b79e', '#c0a68d', '#b99b8a', '#d8c1a5'] },
        { id: '4', imageUrl: '/images/AllRunwayImages/SchiaparelliLook4.png', look: 4, colorPalette: ['#e7d4b4', '#c0b49c', '#a8a28d', '#d9c9b7', '#bcb7a2'] },
        { id: '5', imageUrl: '/images/AllRunwayImages/SchiaparelliLook5.png', look: 5, colorPalette: ['#f5e4b4', '#d1b88f', '#a9976c', '#c6b29b', '#e1d0a1'] },
        { id: '6', imageUrl: '/images/AllRunwayImages/SchiaparelliLook6.png', look: 6, colorPalette: ['#f9e0c4', '#d7b89a', '#c4a57a', '#b39c6a', '#e1d0a0'] },
        { id: '7', imageUrl: '/images/AllRunwayImages/SchiaparelliLook7.png', look: 7, colorPalette: ['#f1c9b5', '#d1ab8e', '#b79c70', '#a58d5b', '#c8b49c'] },
        { id: '8', imageUrl: '/images/AllRunwayImages/SchiaparelliLook8.png', look: 8, colorPalette: ['#f2d6a1', '#c6ad7a', '#a28a5f', '#9e7b50', '#d8c68b'] },
        { id: '9', imageUrl: '/images/AllRunwayImages/SchiaparelliLook9.png', look: 9, colorPalette: ['#f0e2b7', '#c6b286', '#9e8c5b', '#a48b61', '#e3d090'] },
        { id: '10', imageUrl: '/images/AllRunwayImages/SchiaparelliLook10.png', look: 10, colorPalette: ['#f7d0a7', '#d4b295', '#b99e6e', '#c0b07e', '#d9c08f'] },
        { id: '11', imageUrl: '/images/AllRunwayImages/SchiaparelliLook11.png', look: 11, colorPalette: ['#f5e2c5', '#d8b799', '#b89a6c', '#b5a574', '#e2d19d'] },
        { id: '12', imageUrl: '/images/AllRunwayImages/SchiaparelliLook12.png', look: 12, colorPalette: ['#f3d1a5', '#d2b087', '#a78e5e', '#9c7b53', '#c8b297'] },
        { id: '13', imageUrl: '/images/AllRunwayImages/SchiaparelliLook13.png', look: 13, colorPalette: ['#f9c9a4', '#d8a77b', '#a87f5a', '#9e7b4e', '#d6c69b'] },
        { id: '14', imageUrl: '/images/AllRunwayImages/SchiaparelliLook14.png', look: 14, colorPalette: ['#f7d3a1', '#d7b28f', '#b59f6f', '#a88e5f', '#e3d28b'] },
